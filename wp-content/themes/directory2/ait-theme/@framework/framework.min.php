...
array();}function
getContentPreview($elementData=array()){$defaultContentPreviewOptions=$this->getContentPreviewDefaultOptions();$contentPreviewOptions=$this->getContentPreviewOptions();$options=array_merge($defaultContentPreviewOptions,$contentPreviewOptions);if($options['layout']===false||$options['columns']===false)return
null;ob_start();?>
