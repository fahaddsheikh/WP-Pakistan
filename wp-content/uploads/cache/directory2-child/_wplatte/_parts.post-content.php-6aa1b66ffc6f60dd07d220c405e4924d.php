<?php //netteCache[01]000569a:2:{s:4:"time";s:21:"0.06354800 1485769568";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:84:"C:\xampp\htdocs\local_bepakistan\wp-content\themes\directory2\parts\post-content.php";i:2;i:1480566560;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.1";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:3:"1.0";}}}?><?php

// source file: C:\xampp\htdocs\local_bepakistan\wp-content\themes\directory2\parts\post-content.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'zsf5fya0d0')
;
// prolog NUIMacros
...
<?php if (defined('AIT_REVIEWS_ENABLED')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/carousel-reviews-stars", ""), array('item' => $post, 'showCount' => false) + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ;} ?>
							</div>
							<div class="item-data">
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $post->rawDate, 'dateLinks' => 'no', 'dateShort' => 'no') + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ?>
								<h2><a href="<?php echo NTemplateHelpers::escapeHtml($post->permalink, ENT_COMPAT) ?>
"><?php echo $post->title ?></a></h2>
<?php if ($post->type == 'post') { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ;} ?>
...
<?php if ($concreteTaxonomy) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('taxonomy' => $concreteTaxonomy) + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ;} else { if ($post->isInAnyCategory) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('taxonomy' => $concreteTaxonomy) + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ;} } ?>
					</footer> --><!-- /.entry-footer -->
				</article>
<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $post->rawDate, 'dateLinks' => 'no', 'dateShort' => 'yes') + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ?>
...
<?php if ($post->isInAnyCategory) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ;} ?>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ?>
...
<?php if ($post->categoryList) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('taxonomy' => 'category') + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ;} ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/author-bio", ""), array() + get_defined_vars(), $_l->templates['zsf5fya0d0'])->render() ?>
