<?php //netteCache[01]000567a:2:{s:4:"time";s:21:"0.73627000 1485769605";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:82:"C:\xampp\htdocs\local_bepakistan\wp-content\themes\directory2\parts\page-title.php";i:2;i:1480566560;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.1";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:3:"1.0";}}}?><?php

// source file: C:\xampp\htdocs\local_bepakistan\wp-content\themes\directory2\parts\page-title.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '65u2n0pstz')
;
// prolog NUIMacros
...
<?php $eventProMeta = $post->meta('event-pro-data') ;ob_start() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/single-event-date", ""), array('meta' => $eventProMeta, 'place' => 'header', 'eventId' => $post->id) + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ;$eventDateIcon = ob_get_clean() ;} ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $dateIcon, 'dateLinks' => $dateLinks, 'dateShort' => $dateShort) + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ;if (isset($eventDateIcon)) { ?>
...
<?php } ?>
							...
							<?php if ($titleAuthor == 'yes') { ?> 		<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ?>
		<?php } ?>

							<?php if ($titleCategory == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ?>
	<?php } ?>

							<?php if ($titleComments == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ?>
		<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'left') + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'right') + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ?>
			</nav>
<?php } ?>

			</div>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/breadcrumbs", ""), array() + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ?>

		</header><!-- /.entry-header -->

		<!-- page title social icons -->
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/page-share", ""), array('showShare' => $pageShare) + get_defined_vars(), $_l->templates['65u2n0pstz'])->render() ?>
		<!-- page title social icons -->
